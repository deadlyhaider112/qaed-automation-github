...
export class AddonModQuizPlayerPage implements OnInit, OnDestroy, CanLeave {
    ...
    notYetAnswered: CoreQuestionQuestionParsed | undefined;
    ...
    protected async loadSummary(): Promise<void> {
        ...
        // Handling for atleaset one question attemp is must.
        this.showSubmitButton = this.summaryQuestions.some(function(el){
            return el.status == 'Answer saved';
        })
