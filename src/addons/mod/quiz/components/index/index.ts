...
export class AddonModQuizIndexComponent extends CoreCourseModuleMainActivityComponent implements OnInit, OnDestroy {
    ...
    async go(params?: Params , siteId?: string) {
        const course = await CoreCourses.getUserCourse(this.courseId);
        params = params || {};
        Object.assign(params, { course: course });

        await CoreNavigator.navigateToSitePath(`course/${this.courseId}`, { siteId, params });
    }
