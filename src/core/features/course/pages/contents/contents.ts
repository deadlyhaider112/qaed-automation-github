...
export class CoreCourseContentsPage implements OnInit, OnDestroy {
    ...
    downloadEnabledIcon = 'far-check-square'; // Disabled by default.
    ...
    async ngOnInit(): Promise<void> {
        ...
        console.log(this.downloadCourseEnabled);
    ...
    toggleDownload(): void {
        ...
        this.downloadEnabledIcon = this.downloadEnabled ? 'far-square' : 'far-check-square';
    }
