...
import {TimeTableComponent} from "@features/courses/components/time-table/time-table";
...
export class CoreCoursesCategoriesPage implements OnInit {
    ...
    coursecompletionprogress: string | undefined;
    ...
    ngOnInit(): void {
        ...
        console.log(this.coursecompletionprogress);
